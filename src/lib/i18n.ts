...
export const DICTIONARY: Record<Language, Translations> = {
  ...
  id: {
    ...
    tabDissection: 'Lab Bedah',
    tabComparative: 'Komparasi',
    tabAtlas: 'Atlas Benua',
    tabPhylogeny: 'Pohon Hayat',
    tabArchives: '1.025 Arsip',
    ...
    workbenchSubtitle: 'MEJA BEDAH NATURALIS // BIO-DISSEKSI',
    workbenchHeading: 'Stasiun Bedah Anatomi',
